...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            if (!this.customer_phone_number || this.customer_phone_number.length < 6 || !/^\d{10,}$/.test(this.customer_phone_number)) {
                this.formErrors.customer_phone_number = ['Questo campo deve contenere un numero di almeno 6 cifre'];
                isValid = false;
            }
...
<template>
    ...
    <div class="order-page">
        <section class="order_container" v-if="this.total_price > 0">
            ...
            <div>
                ...
                <h1 v-if="!this.orderDone" class="order_title">
                ...
                <div class="order_row">
                    ...
                    <div class="recap_col">
                        <div class="recap_card">
                            <h3 class="recap_title">Riepilogo ordine</h3>
                            <p class="restaurant_name">Ristorante: {{ restaurant_name }}</p>
                            <div>
                                <ul>
                            ...
                            <p v-if="total_price"> <span class="tot_order">Totale Ordine:</span>
                    ...
                    <div class="order_col">
                        ...
                        <form v-if="!this.orderDone" action="" method="post" @submit.prevent="newOrder">
                            ...
                            <div class="order_form">
                                <label for="customer_name" class="form_label">
                            ...
                            <div class="order_form">
                                ...
                                <input type="text" class="form-control pad-3" name="customer_address"
                                    id="customer_address" aria-describedby="helpId" v-model="customer_address"
                            ...
                            <div class="order_form">
                                ...
                                <template v-if="formErrors.customer_phone_number">
                                    <div class="text-red" v-for="error in formErrors.customer_phone_number"
                                        :key="error">
                                        {{ error }}
                                    </div>
                                </template>
                            ...
                            <div class="order_form">
                                ...
                                <textarea class="form-control pad-3" name="customer_note" id="customer_note" rows="3"
                                    ...
                                    :class="{ 'border-red': formErrors.customer_note }"></textarea>
                                <!-- errore di validazione lato laravel -->
                        ...
                        <AppLoading v-if="isLoading" class="order_loading" />
