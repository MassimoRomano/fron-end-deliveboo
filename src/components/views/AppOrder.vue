    ...
    <div class="order-page">
        <section class="order p-5" v-if="this.total_price > 0">
            ...
            <div class="container">
                ...
                <h2 v-if="!this.orderDone" class="fw_bold text_center">
                        ...
                        <form v-if="!this.orderDone" action="" method="post" @submit.prevent="newOrder">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control pad-3" name="customer_email"
                                        id="customer_email" v-model="customer_email"
                                        :class="{ 'border-red': formErrors.customer_email }" />
                                    <!-- errore di validazione lato laravel -->
